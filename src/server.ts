    ...
    this.server.setRequestHandler(ListToolsRequestSchema, async () => ({
      tools: [
        ...
        },
        {
          ...
          description: 'Read the contents of a specific output file generated by command execution. Use output_id from list_execution_outputs. Supports partial reading with offset and size limits.',
