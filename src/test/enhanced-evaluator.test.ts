...
describe('EnhancedSafetyEvaluator', () => {
  ...
  describe('contextual analysis', () => {
    ...
    test('should identify sensitive directory operations', async () => {
      ...
      expect(result.contextual_evaluation.analysis.working_directory_risk.is_sensitive_directory).toBe(true);
      expect(result.contextual_evaluation.analysis.working_directory_risk.risk_level).toBeGreaterThan(1);
    });
  });
